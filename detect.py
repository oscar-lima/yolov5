...
from utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadScreenshots, LoadStreams, LoadHololensStream
...
def run(
    ...
    hololens = source.endswith('hololens')
